...
import com.viiku.frauddetection.transactionservice.service.AnomalyDetectionService;
...
public class FraudDetectionServiceImpl implements FraudDetectionService {
    ...
    /**
     * Checks fraud transactions based upon rule based and anomaly
     * @param transactionDto takes this dto
     */
    @Override
...
//            sample.stop(fraudDetectionTimer);
     ...
     * @param transactionDto transactions data
     * @return list
     */
    ...
    /**
     * Transaction velocity based rule for checking transactions
     * @param transactionDto transactions data
     * @return list
     */
    ...
    /**
     * Time based rule for checking transactions at unusual time
     * @param transactionDto transactions data
     * @return list
     */
    ...
    /**
     * Location based rule for checking transactions
     * @param transactionDto transactions data
     * @return list
     */
